...
function createRowACtion(item) {
    ...
    if (!item) {
        ...
        actions = '<button class="btn btn-warning button-cancel always-show" onclick="onEditOrCancel(this, \'CANCEL\')">Cancel</button>' +
            '<button class="btn btn-success button-save always-show" onclick="onSaveOrDelete(this, \'SAVE\')">Save</button>';
        ...
        actions = '<button class="btn btn-info button-edit" onclick="onEditOrCancel(this, \'EDIT\')">Edit</button>' +
            // Hanya tampil setelah klik edit
            '<button class="btn btn-warning button-cancel" onclick="onEditOrCancel(this, \'CANCEL\')">Cancel</button>' +
            '<button class="btn btn-success button-save" onclick="onSaveOrDelete(this, \'SAVE\')">Save</button>' +
            // Selalu tampil
            '<button class="btn btn-danger button-delete" onclick="onSaveOrDelete(this, \'DELETE\')">Delete</button>';
...
function loadRow() {
    ...
    datas.read().sort().forEach(function (item) {
